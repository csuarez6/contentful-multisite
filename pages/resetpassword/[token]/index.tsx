...
const schema = yup.object({
    password: yup.string().required("Dato Requerido").min(6, "Mínimo 6 caracteres"),
    confirmPassword: yup.string().required("Dato Requerido").min(6, "Mínimo 6 caracteres").oneOf([yup.ref("password")], "Contraseñas no coinciden"),
    tID: yup.string(),
    resetT: yup.string(),
});
            ...
            await fetch('/api/customer-password/reset-password', {
                ...
                if (response.status === 201) {
                    ...
                    if (resp.status === 200) {
                        ...
                        setDataModal({
                            children: <ModalContent modalMsg="Ha ocurrido un error al actualizar contraseña, por favor intente nuevamente." />,
                            promoIcon: 'cancel',
            ...
            <section className="block w-1/2 py-12 m-auto">
                ...
                >
                    <p className="text-xl text-center text-red-900">
                        Estimado usuario, ha ocurrido un error al comprobar la información o el servicio no está disponible. <br /><br />
        ...
        return (
            <section className="block w-1/2 py-12 m-auto">
                <HeadingCard
                    ...
                    hideCheck={true}
                >
                    <p className="text-xl text-center">Espere por favor, comprobando información...</p>
                </HeadingCard>
            </section>
        );
    }
        ...
        return (
            <section className="block w-1/2 py-12 m-auto">
                <HeadingCard
                    ...
                    hideCheck={true}
                >
                    <p className="text-xl text-center text-red-900">Estimado usuario, este link no es válido!</p>
