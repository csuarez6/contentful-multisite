...
const getStepContent = (step: number, handleNext, formData, setFormData, productData, quantity, setQuantity, setCurrentStep) => {
  switch (step) {
    case 2:
      return <Verify handleNext={handleNext} formData={formData} setFormData={setFormData} productData={productData} quantity={quantity} setQuantity={setQuantity} />;
    case 3:
      return <AcceptTerms formData={formData} productData={productData} setCurrentStep={setCurrentStep} />;
    default:
      return <PersonalData handleNext={handleNext} formData={formData} setFormData={setFormData} />;
  }
};
            ...
            <div className="grid gap-3 shrink-0 w-96 p-6 rounded-[20px] shadow-[-2px_-2px_0px_rgba(0,0,0,0.04),2px_2px_4px_rgba(0,0,0,0.08)]">
              ...
              <div className="flex gap-3 flex-col items-start min-w-full">
                ...
                <div className="grid grid-cols-2 gap-3 w-full">
                  ...
                  <p className="text-size-subtitle2 text-blue-dark">{quantity}</p>
                </div>
