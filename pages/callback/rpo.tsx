...
const schema = yup.object({
  cuenta_contrato: yup.string().required("Dato requerido"),
  date: yup.date()
        ...
        <div className="bg-white rounded-lg">
          ...
          <form ref={refForm} className="max-w-full flex flex-wrap gap-6" onSubmit={handleSubmit(onSubmit)}>
            <div className="w-full">
              <label className="block text-lg text-grey-30" htmlFor="cuenta_contrato">
              ...
              <TextBox
                ...
                {...register("cuenta_contrato")}
              />
              {errors.cuenta_contrato && <p className="text-red-600 mt-1">{errors.cuenta_contrato?.message}</p>}
            </div>
            <div className="w-full">
              <TextBox
                id="date"
