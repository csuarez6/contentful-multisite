    ...
    fetch("/api/callback", {
      ...
      .then((json) => {
        ...
        if (result.success) {
          gaEventForm({
            category: "Callback",
            label: "Instalación Gasodomésticos - Comercio",
          });
        }
  ...
  const breadcrumbs = {
    items: [
      ...
      },
      {
        ...
        internalLink: {
          urlPaths: ["/comercio/otros-servicios/instalacion"],
        },
      },
      {
  ...
  return (
    <>
      <div className="overflow-hidden">
        <h1 className="sr-only">Callback Instalación Gasodomésticos - Comercio</h1>
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  return {
    props: {
      layout: {
        name: "Callback Instalación Gasodomésticos - Comercio",
        footerInfo,
        headerInfo,
        helpButton,
      },
