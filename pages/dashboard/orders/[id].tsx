...
const subNavigation = [
    ...
    { name: "Compras", href: "/dashboard/orders", icon: ShoppingCartIcon, current: true },
                ...
                <div className="flex items-center justify-between pt-10">
                    ...
                    <div className="flex">
                        <div className="relative hidden pl-10 mr-10 md:block">
                            <label className="absolute right-0 font-bold text-right text-gray-300 uppercase -top-5 text-[12px]">ffffff</label>
