    ...
    <Transition appear show as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={close}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="min-h-full flex justify-center items-center p-2 sm:p-4">
            <Transition.Child
              as={Fragment}
              enter="ease-out duration-300"
            ...
            >
              <Dialog.Panel className={
                classNames(
                  "relative transform w-full max-w-lg overflow-hidden rounded-[20px] bg-white px-6 pt-9 pb-6 align-middle shadow-xl transition-all flex flex-col gap-12 justify-end",
