...
const ProductServices: React.FC<IProductOverviewDetails> = ({
    ...
    const openModal = (service: string, optionsList?: any) => {
        ...
        setmodalChild(service === "shipping" ? <ModalShipping /> : <ModalIntall optionsList={optionsList} />);
                        ...
                        <div className="px-3 py-[10px] gap-2 border-b border-neutral-70">
                            <ul
                                className={classNames(
                                    ...
                                    (warrantyList.length > 0) ? "grid-cols-1 sm:grid-cols-2" : "grid-cols-1"
                                )}
                            >
                                {(warrantyList.length > 0) && warrantyList.map((item, index) => {
                                    return (
                                        <>
                                            <li key={item.id}>
                                                <input
