...
const ReCaptchaBox: React.FC<IReCaptcha> = ({ version, handleChange, classNames }) => {
    const [token, setToken] = useState<string>('');

    useEffect(() => {
        // Component mounted
        showCaptcha("block");
        const interval = setInterval(() => { console.log("ReCaptcha"); }, 1000);
    ...
    if (version && version == '2') {
        ...
        return (
            <ReCaptchaProvider reCaptchaKey={process.env.NEXT_PUBLIC_RECAPTCHA_SITE_KEY_V3} >
