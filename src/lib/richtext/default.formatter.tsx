...
const defaultFormatOptions: Options = {
  renderNode: {
    ...
    [BLOCKS.TABLE_CELL]: (_node: any, children: any) => (
      <td className="pointer-events-auto first:sticky left-0 block w-1/2 flex-shrink-0 md:table-cell md:w-auto px-6 py-4 first:bg-grey-90 bg-white border-t border-neutral-80 text-center first:text-left text-grey-30 first:text-grey-10 leading-none align-top">
        {children}
      </td>
    ),
